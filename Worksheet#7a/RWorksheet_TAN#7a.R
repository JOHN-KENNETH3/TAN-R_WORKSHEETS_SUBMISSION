...
exercise_lvl <- factor(c("l", "n", "n", "i", "l", "l", "n", "n", "i", "l"), 
                   levels = c("n", "l", "i"), ordered = TRUE)
exercise_lvl
...
#(insuitably large units of money)
...
#The standard error is 1.653911
...
write.csv(abalone,"C://Users/Kenneth/Desktop/RProg_Worksheets/Worksheet 7a/abalone.csv")
