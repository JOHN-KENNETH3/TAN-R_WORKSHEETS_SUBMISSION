...
table_data <- data.frame(
  ...
  Gender = c("F","F","F","F","M","F","F","F","M","F","M","F","M","M", "M","M","F","F","M","F","F",
             "M","M","F","M","M","M","M"))
...
#Yes, when the respondents are tall, their shoe sizes are also big. 
#Whereas, if their height is below 70.0, their shoe size are smaller.
...
#Answer: Yes, it is beneficial because it aids in the efficient understanding of data. 
#In months_vector, you do not need to count the number of words because of the function length. 
#Its mode and class are also displayed. You don't have also to manually count the number of 
#times a specific month appears in factor_months _vector because it's already computed.
