...
#“Relationship between No. of Cylinders and Engine Displacement”.
  ...
  ggplot(data = mpg , mapping = aes(x = displ, y = cyl, main = 
              "Relationship between No of Cylinders and Engine Displacement")) 
              + geom_point(mapping=aes(colour = "engine displacement")) + geom_jitter()
  
  
  #b. How would you describe its relationship?
  #Less cylinders means less inertia in the engine. That is why
  #as the number of cylinders increases, the dots that represents
  #the engine displacement also increased.
